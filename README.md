...
#> font could be found for family "cmr"
...
#> Warning in logo(position = "bottom-right", size = 0.08): Logo file not found
#> at: . Using placeholder.
#> Warning in grid.Call(C_textBounds, as.graphicsAnnot(x$label), x$x, x$y, : no
#> font could be found for family "cmr"
#> Warning in grid.Call(C_textBounds, as.graphicsAnnot(x$label), x$x, x$y, : no
#> font could be found for family "cmr"
...
ggplot(mtcars, aes(x = factor(cyl), fill = factor(cyl))) +
  geom_bar() +
  theme_arpc() +
  logo(position = "top-left", size = 0.08) +
  labs(
...
#> Warning in logo(position = "top-left", size = 0.08): Logo file not found at: .
#> Using placeholder.
#> Warning in grid.Call(C_textBounds, as.graphicsAnnot(x$label), x$x, x$y, : no
#> font could be found for family "cmr"
#> Warning in grid.Call(C_textBounds, as.graphicsAnnot(x$label), x$x, x$y, : no
